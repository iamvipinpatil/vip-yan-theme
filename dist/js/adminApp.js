    ...
    $.AdminLTE.layout = {
        ...
        fix: function () {
            var a = $(".main-header").outerHeight() + $(".main-footer").outerHeight(),
                b = $(window).height(),
                c = $(".sidebar").height();
            if ($("#maincontent").hasClass("fixed")) $(".content-wrapper, .right-side").css("min-height", b - $(".main-footer").outerHeight());
            else {
                var d;
        ...
        fixSidebar: function () {
            return $("#maincontent").hasClass("fixed") ? ("undefined" == typeof $.fn.slimScroll && window.console && window.console.error("Error: the fixed layout requires the slimscroll plugin!"), void ($.AdminLTE.options.sidebarSlimScroll && "undefined" != typeof $.fn.slimScroll && ($(".sidebar").slimScroll({
                destroy: !0
        ...
        activate: function (a) {
            ...
            $(document).on("click", a, function (a) {
                a.preventDefault(), $(window).width() > b.sm - 1 ? $("#maincontent").hasClass("sidebar-collapse") ? $("#maincontent").removeClass("sidebar-collapse").trigger("expanded.pushMenu") : $("#maincontent").addClass("sidebar-collapse").trigger("collapsed.pushMenu") : $("#maincontent").hasClass("sidebar-open") ? $("#maincontent").removeClass("sidebar-open").removeClass("sidebar-collapse").trigger("collapsed.pushMenu") : $("#maincontent").addClass("sidebar-open").trigger("expanded.pushMenu")
            }), $(".content-wrapper").click(function () {
                $(window).width() <= b.sm - 1 && $("#maincontent").hasClass("sidebar-open") && $("#maincontent").removeClass("sidebar-open")
            }), ($.AdminLTE.options.sidebarExpandOnHover || $("#maincontent").hasClass("fixed") && $("#maincontent").hasClass("sidebar-mini")) && this.expandOnHover()
        },
        expandOnHover: function () {
            var a = this,
                b = $.AdminLTE.options.screenSizes.sm - 1;
            $(".main-sidebar").hover(function () {
                $("#maincontent").hasClass("sidebar-mini") && $("#maincontent").hasClass("sidebar-collapse") && $(window).width() > b && a.expand()
            }, function () {
                $("#maincontent").hasClass("sidebar-mini") && $("#maincontent").hasClass("sidebar-expanded-on-hover") && $(window).width() > b && a.collapse()
            })
        },
        expand: function () {
            $("#maincontent").removeClass("sidebar-collapse").addClass("sidebar-expanded-on-hover")
        },
        collapse: function () {
            $("#maincontent").hasClass("sidebar-expanded-on-hover") && $("#maincontent").removeClass("sidebar-expanded-on-hover").addClass("sidebar-collapse")
        }
        ...
        $(document).off("click", a + " li a").on("click", a + " li a", function (a) {
            var d = $(this),
                e = d.next();
            if (e.is(".treeview-menu") && e.is(":visible") && !$("#maincontent").hasClass("sidebar-collapse")) e.slideUp(c, function () {
                ...
                e.slideDown(c, function () {
					...
					f.find("li.treeview.active").removeClass("active"), 
					f.find("li.active").addClass("active"), 
					h.addClass("active"), 
					b.layout.fix()
                })
            }
        ...
        activate: function () {
            ...
            d.on("click", function (d) {
                d.preventDefault(), c.hasClass("control-sidebar-open") || $("#maincontent").hasClass("control-sidebar-open") ? a.close(c, b.slide) : a.open(c, b.slide)
            });
            var e = $(".control-sidebar-bg");
            a._fix(e), $("#maincontent").hasClass("fixed") ? a._fixForFixed(c) : $(".content-wrapper, .right-side").height() < c.height() && a._fixForContent(c)
        },
        open: function (a, b) {
            b ? a.addClass("control-sidebar-open") : $("#maincontent").addClass("control-sidebar-open")
        },
        close: function (a, b) {
            b ? a.removeClass("control-sidebar-open") : $("#maincontent").removeClass("control-sidebar-open")
        },
        _fix: function (a) {
            var b = this;
            if ($("#maincontent").hasClass("layout-boxed")) {
        ...
        collapse: function (a) {
            var b = this,
                ...
                d = c.find("> .box-#maincontent, > .box-footer, > form  >.box-#maincontent, > form > .box-footer");
...
$.AdminLTE = {}, $.AdminLTE.options = {
    ...
    "use strict";
    $("#maincontent").removeClass("hold-transition"), "undefined" != typeof AdminLTEOptions && $.extend(!0, $.AdminLTE.options, AdminLTEOptions);
    ...
    }).css("width", "100%"), a.sidebarPushMenu && $.AdminLTE.pushMenu.activate(a.sidebarToggleSelector), a.enableBSToppltip && $("#maincontent").tooltip({
        ...
        a.fn.boxRefresh = function (b) {
            ...
            return this.each(function () {
                ...
                f.on("click", function (a) {
                    a.preventDefault(), c(b), b.find(".box-#maincontent").load(e.source, function () {
                        d(b)
                    })
                })
            })
